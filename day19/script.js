...
{   try
    ...
    info1.innerHTML = "TEMPERATURE : " + data.main.temp + String.fromCharCode(176) + "C";
    info5.innerHTML="HUMIDITY: "+data.main.humidity+"%";
    info3.innerHTML="WIND SPEED: "+data.wind.speed+"m/s";
    info4.innerHTML="PRESSURE:"+data.main.pressure+"Pa";
